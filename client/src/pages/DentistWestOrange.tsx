...
export default function DentistWestOrange() {
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16 md:py-24 bg-gradient-to-r from-primary/5 to-accent/5">
        <div className="container max-w-4xl">
          ...
          <h1 className="text-5xl md:text-6xl font-bold text-primary mb-6">Dentist in West Orange, NJ</h1>
          <p className="text-xl text-foreground/80 leading-relaxed mb-8">
            ProCare Dental is your trusted dental provider serving West Orange and surrounding communities. We offer comprehensive dental care with state-of-the-art technology and compassionate service.
          </p>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container max-w-4xl">
          <h2 className="text-4xl font-bold text-primary mb-12">Dental Services for West Orange Residents</h2>
          <div className="grid md:grid-cols-2 gap-8">
            {[
              { title: "Family Dentistry", desc: "Comprehensive dental care for the entire family in West Orange" },
              { title: "Cosmetic Dentistry", desc: "Enhance your smile with professional cosmetic treatments" },
              { title: "Dental Implants", desc: "Permanent tooth replacement solutions for West Orange patients" },
      ...
      <section className="py-16 md:py-24 bg-secondary">
        <div className="container max-w-4xl">
          <h2 className="text-4xl font-bold text-primary mb-8">Why Choose ProCare Dental for West Orange?</h2>
          <ul className="space-y-4">
            {[
              "Conveniently located near West Orange with easy access",
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container max-w-4xl">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div>
              <h3 className="text-xl font-semibold text-primary mb-4">Serving West Orange</h3>
              <p className="text-foreground/80 mb-4">
                ProCare Dental proudly serves patients from West Orange, Livingston, Verona, Montclair, and surrounding communities. We're committed to providing the highest quality dental care to all our patients.
              </p>
      ...
      <footer className="bg-primary text-white py-12">
        <div className="container text-center text-sm text-white/70">
          <p>&copy; 2026 ProCare Dental. All rights reserved. | Dentist in West Orange, NJ</p>
        </div>
      </footer>
    </div>
  );

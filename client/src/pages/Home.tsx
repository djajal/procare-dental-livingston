              ...
              <div className="flex flex-wrap gap-8 pt-6">
                ...
                {zocdocReviews ? (
                  <a href={zocdocReviews.profileUrl} target="_blank" rel="noopener noreferrer" className="flex items-center gap-6 hover:opacity-80 transition">
                    <img src="https://d2xsxph8kpxj0f.cloudfront.net/310519663355308413/VwPTW3VCJkeR46zZ3DPjBz/Zocdoc_e550411c.png" alt="ZocDoc" className="w-16 h-16 flex-shrink-0" />
                    <div className="flex flex-col">
                      <div className="flex items-center gap-2">

...
export const DentistVerona = () => <TownPage townName="Verona" townPath="verona" />;
export const DentistMontclair = () => <TownPage townName="Montclair" townPath="montclair" />;
export const DentistBloomfield = () => <TownPage townName="Bloomfield" townPath="bloomfield" />;
export const DentistEssexFells = () => <TownPage townName="Essex Fells" townPath="essex-fells" />;
